...
```bash
curl -X POST "https://faith-radio-app.preview.emergentagent.com/api/donations" \
  -H "Content-Type: application/json" \
  -d '{
...
curl "https://faith-radio-app.preview.emergentagent.com/api/your-new-endpoint"

# Test with data
curl -X POST "https://faith-radio-app.preview.emergentagent.com/api/your-endpoint" \
  -H "Content-Type: application/json" \
  -d '{"test": "data"}'
```
...
curl -w "@/dev/stdin" "https://faith-radio-app.preview.emergentagent.com/api/" <<< "
...
3. **Test New Feature**:
```bash
curl -X POST "https://faith-radio-app.preview.emergentagent.com/api/events" \
  -H "Content-Type: application/json" \
  -d '{
