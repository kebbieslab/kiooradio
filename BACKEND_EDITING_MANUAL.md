...
```bash
curl -X POST "https://dropbox-crm.preview.emergentagent.com/api/impact-stories" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST "https://dropbox-crm.preview.emergentagent.com/api/news" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://dropbox-crm.preview.emergentagent.com/api/donations/total"
```

Add new donation record:
```bash
curl -X POST "https://dropbox-crm.preview.emergentagent.com/api/donations" \
  -H "Content-Type: application/json" \
  -d '{
...
curl "https://dropbox-crm.preview.emergentagent.com/api/your-new-endpoint"

# Test with data
curl -X POST "https://dropbox-crm.preview.emergentagent.com/api/your-endpoint" \
  -H "Content-Type: application/json" \
  -d '{"test": "data"}'
```
...
curl -w "@/dev/stdin" "https://dropbox-crm.preview.emergentagent.com/api/" <<< "
...
3. **Test New Feature**:
```bash
curl -X POST "https://dropbox-crm.preview.emergentagent.com/api/events" \
  -H "Content-Type: application/json" \
  -d '{
