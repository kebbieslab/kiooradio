        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              {/* Presenters Dashboard Link */}
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="text-center">
                  <a
                    href="/kioo-presenters-dashboard-1981"
                    className="inline-flex items-center bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors duration-200 text-sm font-medium"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                    Access Presenters Dashboard
                  </a>
                  <p className="text-xs text-gray-600 mt-2">Internal tool for radio presenters</p>
                </div>
              </div>
            </div>
          </div>
