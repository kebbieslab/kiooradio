            ...
            <div className="flex justify-between items-center py-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">
                  {t('visitors_testimonies') || 'Visitors & Testimonies'}
                </h1>
                <p className="text-sm text-gray-500">
                  {t('manage_visitor_records') || 'Manage visitor records and testimonies'}
                </p>
              </div>
              <div className="flex space-x-4">
                ...
                >
                  {t('add_visitor_testimony') || 'Add Visitor/Testimony'}
                </button>
                <button
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  >
                    <option value="">{t('all_programs') || 'All Programs'}</option>
                ...
                <div>
                  ...
                  >
                    <option value="">{t('all_sources') || 'All Sources'}</option>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg leading-6 font-medium text-gray-900">
                  {t('visitors_list') || 'Visitors List'} ({visitors.length})
                </h3>
              </div>
              ...
              <div className="overflow-x-auto">
                ...
                {visitors.length === 0 && !loading && (
                  <div className="text-center py-8 text-gray-500">
                    {t('no_visitors_found') || 'No visitors found'}
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="mt-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
                        {t('county_prefecture') || 'County/Prefecture'}
                      </label>
                      <input
                        type="text"
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-kioo-primary focus:border-kioo-primary sm:text-sm"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Morning Devotion">{t('morning_devotion') || 'Morning Devotion'}</option>
                        <option value="French Gospel">{t('french_gospel') || 'French Gospel'}</option>
                        <option value="Evening Prayer">{t('evening_prayer') || 'Evening Prayer'}</option>
                        <option value="Youth Hour">{t('youth_hour') || 'Youth Hour'}</option>
                        <option value="Sunday Service">{t('sunday_service') || 'Sunday Service'}</option>
                        <option value="Bible Study">{t('bible_study') || 'Bible Study'}</option>
                        <option value="Other">{t('other') || 'Other'}</option>
                      </select>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="call">{t('phone_call') || 'Phone Call'}</option>
                        <option value="visit">{t('in_person') || 'In Person'}</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
                      ...
                      >
                        <option value="Y">{t('yes_consent') || 'Yes - Consent given'}</option>
                        <option value="N">{t('no_consent') || 'No - Consent not given'}</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder={t('testimony_placeholder') || 'Share how Kioo Radio has impacted your life...'}
                    />
                  </div>
                  ...
                  <div className="flex justify-end space-x-3 pt-4">
                    ...
                    >
                      {loading 
                        ? (t('saving') || 'Saving...') 
                        : editingVisitor 
                          ? (t('update_visitor') || 'Update Visitor')
                          : (t('add_visitor') || 'Add Visitor')
                      }
                    </button>
                  </div>
                </form>
