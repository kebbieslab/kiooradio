...
### ✅ Live Website
- **URL**: https://mission-crm.preview.emergentagent.com
- **Backend API**: https://mission-crm.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://mission-crm.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://mission-crm.preview.emergentagent.com
