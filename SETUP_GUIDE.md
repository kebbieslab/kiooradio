...
- **Backend API**: https://radio-weather-hub.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://radio-weather-hub.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://radio-weather-hub.preview.emergentagent.com
