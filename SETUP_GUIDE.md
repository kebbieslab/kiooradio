...
### ✅ Live Website
- **URL**: https://kioo-mission.preview.emergentagent.com
- **Backend API**: https://kioo-mission.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://kioo-mission.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://kioo-mission.preview.emergentagent.com
