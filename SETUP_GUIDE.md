...
- **Backend API**: https://kioo-radio-crm.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://kioo-radio-crm.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://kioo-radio-crm.preview.emergentagent.com
