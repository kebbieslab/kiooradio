...
- **Backend API**: https://pedantic-sanderson.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://pedantic-sanderson.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://pedantic-sanderson.preview.emergentagent.com
