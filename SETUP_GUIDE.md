...
- **Backend API**: https://faith-broadcast-1.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://faith-broadcast-1.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://faith-broadcast-1.preview.emergentagent.com
