...
- **Backend API**: https://kioo-broadcast-mgmt.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://kioo-broadcast-mgmt.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://kioo-broadcast-mgmt.preview.emergentagent.com
