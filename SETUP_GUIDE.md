...
- **Backend API**: https://faith-radio-app.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://faith-radio-app.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://faith-radio-app.preview.emergentagent.com
