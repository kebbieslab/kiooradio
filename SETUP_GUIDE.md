...
- **Backend API**: https://farmer-weather.preview.emergentagent.com/api
...
# Test API endpoint
curl -X POST "https://farmer-weather.preview.emergentagent.com/api/contact" \
  -H "Content-Type: application/json" \
...
- **Manual Testing**: Browse https://farmer-weather.preview.emergentagent.com
