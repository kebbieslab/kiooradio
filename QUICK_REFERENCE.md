...
```bash
# View all programs
curl "https://faith-broadcast-1.preview.emergentagent.com/api/programs"

# View donation total  
curl "https://faith-broadcast-1.preview.emergentagent.com/api/donations/total"

# View all news
curl "https://faith-broadcast-1.preview.emergentagent.com/api/news"
```

## 📱 Website URLs
- **Live Site**: https://faith-broadcast-1.preview.emergentagent.com
- **API Docs**: https://faith-broadcast-1.preview.emergentagent.com/docs (Coming soon)
- **API Root**: https://faith-broadcast-1.preview.emergentagent.com/api/
