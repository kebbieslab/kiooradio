...
```bash
# View all programs
curl "https://mission-crm.preview.emergentagent.com/api/programs"

# View donation total  
curl "https://mission-crm.preview.emergentagent.com/api/donations/total"

# View all news
curl "https://mission-crm.preview.emergentagent.com/api/news"
```

## 📱 Website URLs
- **Live Site**: https://mission-crm.preview.emergentagent.com
- **API Docs**: https://mission-crm.preview.emergentagent.com/docs (Coming soon)
- **API Root**: https://mission-crm.preview.emergentagent.com/api/
